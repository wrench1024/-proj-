<template>
  <div class="knowledge-entry">
    <!-- 顶部标题栏 -->
    <div class="header">
      <h1 class="title">水资源论证智能审查AI助手</h1>
      <div class="user-info">
        <span>用户名：管理员</span>
        <span>退出</span>
      </div>
    ...
    <div class="main-container">
      ...
      <div class="sidebar">
        ...
        <div class="nav-item" :class="{ active: activeNav === 'knowledge' }" @click="activeNav = 'knowledge'">
          <span>知识入库</span>
        </div>
        <div class="nav-item" :class="{ active: activeNav === 'review' }" @click="activeNav = 'review'">
          <span>审查管理</span>
        </div>
      </div>
                ...
                <div class="filter-row">
                  ...
                  <div class="filter-item">
                    ...
                    <div class="status-options">
                      <button
                        class="status-btn"
                        :class="{ active: historyStatus === 'all' }"
                      ...
                      <button
                        class="status-btn"
                        :class="{ active: historyStatus === 'processing' }"
                      ...
                      <button
                        class="status-btn"
                        :class="{ active: historyStatus === 'failed' }"
                      ...
                      <button
                        class="status-btn"
                        :class="{ active: historyStatus === 'success' }"
